<?php
    ...
    if(true) {
        ...
        $qr="SELECT * FROM tintuyendung ORDER BY views DESC LIMIT 0,10 ";
...
class congviec{
	...
	var $nganhnghe;
	var $motact;
	function congviec($i,$matd,$views,$t,$ct,$dc,$qm,$nganhnghe,$mota,$m,$dd,$g,$motacv,$bc,$age,$nn,$sex,$khac,$kn,$img,$sdt){
		$this->sdt=$sdt;
		$this->diachi=$dc;
		$this->views=$views;
		$this->quymo=$qm;
